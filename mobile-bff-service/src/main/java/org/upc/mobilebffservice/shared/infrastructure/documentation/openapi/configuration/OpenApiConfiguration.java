package org.upc.mobilebffservice.shared.infrastructure.documentation.openapi.configuration;
...
public class OpenApiConfiguration {
    ...
    private Info apiInfo() {
        return new Info()
                .title("MOBILE BFF SERVICE API")
                .description("REST API documentation for MOBILE BFF SERVICE - Direct evidence uploads")
                .version("v1.0.0")
                .license(new License()
                        .name("Apache 2.0")
